$(document).ready(function(){
	...
	var questions = [
		...
		{"question":"2. As of March 2016, only 3 teams have won the title during the last 5 Stanley Cup Championshps. Which of the following teams is not one of them?",
			"choiceA":"  A)   Los Angeles Kings",
			"choiceB":"  B)   Boston Bruins",
			"choiceC":"  C)   Pittsburgh Penguins",
			"choiceD":"  D)   Chicago Blackhawks"},
		{"question":'3. Which hockey player is referred to as "The Great One"?',
			"choiceA":"  A)   Wayne Gretzky",
			"choiceB":"  B)   Mark Messier",
			"choiceC":"  C)   Sidney Crosby",
			"choiceD":"  D)   Patrick Kane"},
		{"question":"4. Where is the Hockey Hall of Fame?",
			"choiceA":"  A)   New York City",
			"choiceB":"  B)   Toronto",
			"choiceC":"  C)   Montreal",
			"choiceD":"  D)   Ottawa"},
		{"question":"5. What is the penalty for fighting during a game in the NHL?",
			"choiceA":"  A)   None",
			"choiceB":"  B)   2 min in the penalty box",
			"choiceC":"  C)   At least 5 min in the penalty box",
			"choiceD":"  D)   Thrown out of game"}
	];
