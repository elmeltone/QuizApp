!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";var r=n(1);r(function(){function e(e){var t=n[e];return'<br><span classs="question">'+t.question+'</span><br><div class="choices"><span><button class="answer" value="0">'+t.options[0]+'</button></span><br><span><button class="answer" value="1">'+t.options[1]+'</button></span><br><span><button class="answer" value="2">'+t.options[2]+'</button></span><br><span><button class="answer" value="3">'+t.options[3]+"</button></span><br></div><br>"}function t(){o+=1,6>o?r("#quiz").empty().html(e(o)):6==o?r("#quiz").empty().html('<br><span class="question"><br>Thanks for playing!<br></span><br><button class="startOver" type="button" value="null">START OVER</button><br>'):(r("#quiz").html(i),o=0),r("#quiz").scrollTop(0)}console.log("ready");var n=[{question:"READY?"},{question:"1. Which of these things are not commonly thrown on the ice by hockey fans in at least one city with an NHL team?",options:["Rats","Octopi","Pucks","Hats"],correct:"2"},{question:"2. As of March 2016, only 3 teams have won the title over the last 5 Stanley Cup Championshps. Which of the following teams is not one of them?",options:["Los Angeles Kings","Boston Bruins","Chicago Blackhawks","Pittsburgh Penguins"],correct:"3"},{question:'3. Which hockey player is referred to as "The Great One"?',options:["Wayne Gretzky","Mark Messier","Sidney Crosby","Patrick Kane"],correct:"0"},{question:"4. Where is the Hockey Hall of Fame?",options:["New York City","Toronto","Montreal","Ottawa"],correct:"1"},{question:"5. What is the penalty for fighting during a game in the NHL?",options:["None","2 min in the penalty box","At least 5 min in the penalty box","Thrown out of game"],correct:"2"}],i='<br><span class="question">'+n[0].question+'</span><br><br><div id="idBox"><button class="start" type="button" value="null">START</button></div>',o=0;r("#quiz").html(i),r(document).on("click",".start",function(){t()}),r(document).on("click",".answer",function(){var e=r(this).attr("value");e==n[o].correct?(console.log("correct"),r("#footer").append('<img class="icon" src="http://i.imgur.com/qwvd4F4.gif" alt="lamp">')):(console.log("incorrect"),r("#footer").append('<img class="icon" src="http://i.imgur.com/HUe53pP.gif" alt="lamp">')),t()}),r(document).on("click",".startOver",function(){r("#quiz").empty().html(i),o=0,r("#footer").empty().html("<p>Score:</p>")})})},function(e,t,n){var r,i;/*!
