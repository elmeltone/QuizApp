!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function r(e){var t=s[e];return'<br><span classs="question">'+t.question+'</span><br><div class="choices"><span><button class="answer" value="0">'+t.options[0]+'</button></span><br><span><button class="answer" value="1">'+t.options[1]+'</button></span><br><span><button class="answer" value="2">'+t.options[2]+'</button></span><br><span><button class="answer" value="3">'+t.options[3]+"</button></span><br></div><br>"}function i(){u+=1,6>u?o("#quiz").empty().html(r(u)):6==u?o("#quiz").empty().html('<br><span class="question"><br>Thanks for playing!<br></span><br><button class="startOver" type="button" value="null">START OVER</button><br>'):(o("#quiz").html(a),u=0),o("#quiz").scrollTop(0)}var o=n(1),s=n(2),a='<br><span class="question">'+s[0].question+'</span><br><br><div id="idBox"><button class="start" type="button" value="null">START</button></div>',u=0;o(function(){console.log("ready"),o("#quiz").html(a),o(document).on("click",".start",function(){i()}),o(document).on("click",".answer",function(){var e=o(this).attr("value");e==s[u].correct?(console.log("correct"),o("#footer").append('<img class="icon" src="http://i.imgur.com/qwvd4F4.gif" alt="lamp">')):(console.log("incorrect"),o("#footer").append('<img class="icon" src="http://i.imgur.com/HUe53pP.gif" alt="lamp">')),i()}),o(document).on("click",".startOver",function(){o("#quiz").empty().html(a),u=0,o("#footer").empty().html("<p>Score:</p>")})})},function(e,t,n){var r,i;/*!
